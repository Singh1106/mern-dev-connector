...
const EditProfile = ({ createProfile, getCurrentProfile, profile }) => {
  ...
  const onSubmit = (e) => {
    e.preventDefault();
    const res = createProfile(formData, true); // somehow it returns true and false in a promise. ddont know why.
    res.then((result) => {
